...
ACTIONS_BUTTONS_MAPPING = {
    FORM_ACTION_WISHLIST: {
        "show": [FORM_ACTION_REMOVE_WISHLIST],
        "hide": [],
    },
    FORM_ACTION_REMOVE_WISHLIST: {
        "show": [FORM_ACTION_WISHLIST],
        "hide": [],
    },
    FORM_ACTION_PLAYING: {
    ...
    FORM_ACTION_REMOVE_NOT_OWNED: {
        "show": [FORM_ACTION_NOT_OWNED],
        "hide": [],
    },
    FORM_ACTION_ADD_TO_CATALOG: {
        "show": [
            FORM_ACTION_REMOVE_FROM_CATALOG, FORM_ACTION_PLAYING, FORM_ACTION_FINISHED, FORM_ACTION_NOT_OWNED,
    ...
    FORM_ACTION_REMOVE_FROM_CATALOG: {
        ...
        "hide": [
            FORM_ACTION_PLAYING, FORM_ACTION_REMOVE_PLAYING, FORM_ACTION_FINISHED, FORM_ACTION_REMOVE_FINISHED,
            FORM_ACTION_NOT_OWNED, FORM_ACTION_REMOVE_NOT_OWNED, FORM_ACTION_ABANDONED, FORM_ACTION_REMOVE_ABANDONED
        ],
    },
    FORM_ACTION_ABANDONED: {
